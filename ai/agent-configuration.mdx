...
- One agent handles all inquiries
- General purpose assistant

### Multi-Agent Approach
- Large manufacturing facility
- Specialized teams per department
- Complex processes
- Significant document library
...
### Step 6: Set Data Access

Control what agent can see:
- All claims vs. department only
...
Enable for team to use via chat interface.
