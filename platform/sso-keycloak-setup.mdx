...
Single Sign-On (SSO) lets employees use their corporate credentials to login to Intelligate. No separate passwords.
...
**Default credentials**: admin / ChangeMe123Admin (CHANGE THIS!)
...
3. Add roles to user
4. Roles sync to Intelligate on next login
...
- Intelligate syncs organization data

## Syncing Roles to Intelligate
