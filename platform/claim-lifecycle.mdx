...
- 🟠 **Orange/Yellow** = High priority, At-risk SLA
...
- ✅ SLA met (critical deadline 12:15, closed by 1:20)
- ✅ Cross-functional collaboration (Maintenance + Quality + Management)
- ✅ Transparency (all updates visible)
- ✅ Learning (full audit trail for process improvement)
...
- ✅ Add evidence (photos, measurements)
- ✅ Note impact (safety, production, cost)
...
### Meeting SLA
- ✅ Respond immediately to assignments
- ✅ Update status as you work
- ✅ Escalate early if you'll miss deadline
- ✅ Communicate blockers
- ❌ Don't wait until overdue to escalate
- ❌ Don't leave claims unassigned

### Documentation & Learning
- ✅ Document complete solution in comments
- ✅ Attach relevant reference materials
- ✅ Note lessons learned
- ✅ Link to similar past claims
